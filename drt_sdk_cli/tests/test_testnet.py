...
from drt_sdk_cli.localnet.config_software import SoftwareResolution
...
def test_override_config():
    ...
    assert config.software.drt_chain_go.resolution == SoftwareResolution.Remote
    assert config.software.drt_chain_go.archive_url == "https://github.com/DharitriOne/drt-chain-go/archive/refs/heads/master.zip"
    ...
    config_patch["software"] = {
        "drt_chain_go": {
            "archive_url": "https://github.com/DharitriOne/drt-chain-go/archive/refs/tags/v1.5.1.zip"
        }
    }
    ...
    assert config.software.drt_chain_go.resolution == SoftwareResolution.Remote
    assert config.software.drt_chain_go.archive_url == "https://github.com/DharitriOne/drt-chain-go/archive/refs/tags/v1.5.1.zip"
