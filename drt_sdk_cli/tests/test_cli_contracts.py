...
def test_contract_upgrade():
    ...
    contract_address = "moa1qqqqqqqqqqqqqpgq5l9jl0j0gnqmm7hn82zaydwux3s5xuwkyq8swnjrv5"
...
def test_contract_transfer_and_execute(capsys: Any):
    contract_address = "moa1qqqqqqqqqqqqqpgqv7sl6ws5dgwe5m04xtg0dvqyu2efz5a6d8ssttnees"
    ...
    assert data == "DCDTNFTTransfer@4e46542d313233343536@02@01@0000000000000000050067a1fd3a146a1d9a6df532d0f6b004e2b29153ba69e1@616464@05"
    ...
    data = get_transaction_data(capsys)
    assert data == "MultiDCDTNFTTransfer@0000000000000000050067a1fd3a146a1d9a6df532d0f6b004e2b29153ba69e1@02@4e46542d313233343536@02@01@444344542d393837363534@@64@616464@05"
