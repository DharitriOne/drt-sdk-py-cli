...
testVerifyContract(){
    ...
    command_response=$(${CLI} contract verify moa1qqqqqqqqqqqqqpgquzmh78klkqwt0p4rjys0qtp3la07gz4d396q7vfu0t \
...
testReproducibleBuild() {
    ...
    wget -O ${SANDBOX}/example.zip https://github.com/DharitriOne/drt-reproducible-contract-build-example-sc/archive/refs/tags/v0.2.1.zip || return 1
