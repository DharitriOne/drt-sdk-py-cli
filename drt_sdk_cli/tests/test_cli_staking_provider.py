...
def test_create_new_delegation_contract(capsys: Any):
    ...
    assert transaction["receiver"] == "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqylllsjrx4c2"
    assert transaction["chainID"] == "T"
    assert transaction["gasLimit"] == 60126500
    assert transaction["value"] == "1250000000000000000000"
    assert transaction["signature"] == "39c600036faaacf0a11182fc1059fc73ad4e8edb1a437fb5a3c0878f48e4e383a50e72621b7bad65ea8bfeed870d65717a74526da0c4773e7770a6fcdc4de80b"
...
def test_create_new_delegation_contract_with_provided_gas_limit(capsys: Any):
    ...
    assert transaction["value"] == "1250000000000000000000"
    assert transaction["signature"] == "493babddcfdbdb5623d37b2d2204a1965503aa826c5466fa45cba58669d04c530cfd89ac3880c0d0ec403508ad2139f79705236c7c47cb07891ad51f3c39a006"
...
def test_add_nodes(capsys: Any):
    ...
    main([
        ...
        "--delegation-contract", "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqthllllsfv94l8",
        "--pem", str(alice),
        "--chain", "T",
        "--nonce", "7", "--estimate-gas"
    ])
    ...
    assert transaction["sender"] == "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8"
    assert transaction["receiver"] == "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqthllllsfv94l8"
    assert transaction["gasLimit"] == 20367000
    assert transaction["signature"] == "9593a4bf26570ffe1c971fce040256f4a48973ed5714b379f5ca72cb266e01f8940f066b5a4191dd885669e7dee843834dda311ac2dfb42bdb0649aae1487c0a"
...
def test_add_nodes_with_gas_limit(capsys: Any):
    ...
    assert transaction["signature"] == "fa509536f4057b47d83c427477e454e01e5afb1eefb4fd65f5626d10ae8fa42b96511422c2a1f8c8389bf1fbbf8126b738345147997c2842384bc5da1b150a04"
